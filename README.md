...
| [`atlassian-suite`](https://github.com/Acendas/atlassian-suite) | 0.1.5 | Unified Jira Cloud + Confluence Cloud + Bitbucket Cloud integration. 190 MCP tools, 31 workflow skills, 21 agents including a 12-scanner PR review pipeline with adversarial critic. |
